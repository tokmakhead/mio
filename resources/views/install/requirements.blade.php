...
@section('content')
    <div class="mb-6">
        <h2 class="text-lg font-bold text-gray-900 dark:text-white">Sunucu Gereksinimleri</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400">Uygulamanın çalışması için gerekli PHP eklentileri.</p>
    </div>

    <div class="space-y-3 mb-8">
        @foreach($requirements as $requirement => $isMet)
