<x-app-layout>
    <!-- Page Banner -->
    <x-page-banner title="Yeni Müşteri" subtitle="Yeni bir müşteri ekleyin" />
                ...
                <form action="{{ route('customers.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label
                                class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all {{ old('type') == 'individual' || !old('type') ? 'border-primary-600 bg-primary-50 dark:bg-primary-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-primary-300' }}">
                                <input type="radio" name="type" value="individual" class="sr-only" {{ old('type') == 'individual' || !old('type') ? 'checked' : '' }}
                            ...
                            <label
                                class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all {{ old('type') == 'corporate' ? 'border-primary-600 bg-primary-50 dark:bg-primary-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-primary-300' }}">
                                <input type="radio" name="type" value="corporate" class="sr-only" {{ old('type') == 'corporate' ? 'checked' : '' }}
                                    onchange="this.form.querySelectorAll('label').forEach(l => l.classList.remove('border-primary-600', 'bg-primary-50', 'dark:bg-primary-900/20')); this.parentElement.classList.add('border-primary-600', 'bg-primary-50', 'dark:bg-primary-900/20');">
                                <div class="flex items-center space-x-3">
                                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="mobile_phone" id="mobile_phone"
                                    value="{{ old('mobile_phone') }}" placeholder="0532 123 45 67"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primary-500 focus:ring-primary-500">
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="tax_or_identity_number" id="tax_or_identity_number"
                                    value="{{ old('tax_or_identity_number') }}"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primary-500 focus:ring-primary-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="country" id="country" value="{{ old('country', 'TR') }}"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primary-500 focus:ring-primary-500">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="invoice_address[address]" id="invoice_address_text" rows="3"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primary-500 focus:ring-primary-500">{{ old('invoice_address.address') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="invoice_address[city]" id="invoice_city"
                                    value="{{ old('invoice_address.city') }}"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primary-500 focus:ring-primary-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="invoice_address[district]" id="invoice_district"
                                    value="{{ old('invoice_address.district') }}"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primary-500 focus:ring-primary-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="invoice_address[postal_code]" id="invoice_postal_code"
                                    value="{{ old('invoice_address.postal_code') }}"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primary-500 focus:ring-primary-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="invoice_address[country]" id="invoice_country"
                                    value="{{ old('invoice_address.country', 'TR') }}"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primary-500 focus:ring-primary-500">
                            </div>
                        </div>
                    </div>
