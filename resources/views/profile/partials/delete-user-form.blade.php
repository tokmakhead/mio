<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            {{ __('Hesabınız silindiğinde, tüm kaynakları ve verileri kalıcı olarak silinecektir. Hesabınızı silmeden önce, saklamak istediğiniz tüm verileri veya bilgileri lütfen indirin.') }}
        </p>
    </header>
