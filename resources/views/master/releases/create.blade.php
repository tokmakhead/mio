...
@section('content')
    ...
    <div class="max-w-3xl">
        <div
            ...
            <div class="p-6">
                <form action="{{ route('master.releases.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Version -->
                            <div>
                                <label for="version" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Sürüm Numarası</label>
                            ...
                            <!-- ZIP File -->
                            <div>
                                <label for="release_file" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Sürüm Dosyası (.zip)</label>
                                <input type="file" name="release_file" id="release_file" accept=".zip"
                                    class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
                                    required>
                                <p class="mt-1 text-xs text-gray-500">Maksimum dosya boyutu: 50MB</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Release Notes -->
                    <div>
                        <label for="release_notes" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Sürüm
                            Notları</label>
