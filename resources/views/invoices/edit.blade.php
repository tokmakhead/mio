<x-app-layout>
    <x-page-banner title="Faturayı Düzenle" subtitle="{{ $invoice->number }} - {{ $invoice->customer->name }}" />
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea name="notes" rows="4" placeholder="Kayıt notları..."
                                        class="w-full rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white text-sm">{{ old('notes', $invoice->notes) }}</textarea>
                                </div>
                            </div>
                        </x-card>
    ...
    @push('scripts')
        @php
            $jsItems = $invoice->items->map(fn($item) => [
