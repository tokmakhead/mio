    ...
    <x-page-banner title="Finans Merkezi"
        ...
        <x-slot name="metric">
            <div class="text-right">
                <span class="block text-xs text-white/70 uppercase font-bold tracking-wider">Onay Bekleyen Tahsilatlar</span>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <x-kpi-card title="Fatura Tutarı" value="{{ number_format($totalAmount, 2) }} ₺" tone="primary"
                ...
                <x-kpi-card title="Onay Bekleyen Ödemeler" value="{{ number_format($totalPending, 2) }} ₺"
                    tone="warning"
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                    ...
                    <div class="flex space-x-3">
                        <a href="{{ route('accounting.reconciliation.index') }}"
                            class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-lg shadow-indigo-500/30 transition-all duration-200 transform hover:-translate-y-0.5">
                            ...
                            @forelse($invoices as $invoice)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-gray-500 tracking-tight">{{ $invoice->customer->email }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-bold text-gray-900 dark:text-white">
                                            {{ number_format($invoice->grand_total, 2) }} {{ $invoice->currency }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div
