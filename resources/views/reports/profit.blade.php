    ...
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div
            ...
            <form method="GET" action="{{ route('reports.profit') }}"
                ...
                {{-- Tarih Aralığı --}}
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">BAŞLANGIÇ</label>
                ...
                <div x-data="{ curr: '{{ $currency }}' }" class="space-y-2">
                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">USD KURU</label>
                ...
                <div x-data="{ curr: '{{ $currency }}' }" class="space-y-2">
                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">EUR KURU</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div
                ...
                <div class="relative">
                    <div class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4">TOPLAM CİRO</div>
            ...
            <div
                ...
                <div class="relative">
                    ...
                    <div class="mt-2 text-[10px] font-bold text-red-500 uppercase tracking-tighter">TEORİK ALIŞ TUTARI
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="relative">
                    <div class="text-[10px] font-black text-primary-500 uppercase tracking-widest mb-4">NET OPERASYONEL
                        KÂR</div>
                    <div
            ...
            <div
                ...
                <div class="relative">
                    <div class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4">ORTALAMA MARJ</div>
                    <div class="text-3xl font-black text-gray-900 dark:text-gray-100 tracking-tight">
                        %{{ $report['total_revenue'] > 0 ? number_format(($report['net_profit'] / $report['total_revenue']) * 100, 1) : 0 }}
                    </div>
                    <div class="mt-2 text-[10px] font-bold text-yellow-500 uppercase tracking-tighter">KÂRLILIK ORANI
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <td colspan="7" class="px-8 py-24 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-sm font-black text-gray-400 uppercase tracking-widest">VERİ
                                            BULUNAMADI</h3>
                                        <p class="text-xs text-gray-400 mt-1">Seçilen kriterlere uygun herhangi bir kârlılık
