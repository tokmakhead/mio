<x-app-layout>
    <!-- Page Banner -->
    <x-page-banner title="Teklif Düzenle" subtitle="{{ $quote->number }} - {{ $quote->customer->name }}" />
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="notes" rows="3"
                                        class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-primary-500 focus:border-primary-500">{{ old('notes', $quote->notes) }}</textarea>
                                </div>
                            </div>
                        </x-card>
            ...
            function quoteForm() {
                return {
                    ...
                    onServiceChange(index, serviceId) {
                        if (!serviceId) { this.items[index].service_id = ''; return; }
