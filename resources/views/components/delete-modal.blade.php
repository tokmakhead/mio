...
<div x-data="{ open: false }">
    <!-- Trigger Button -->
    <button @click="open = true" type="button" {{ $attributes->merge(['class' => 'inline-flex items-center justify-center w-8 h-8 bg-rose-50/50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 rounded-lg transition-all duration-200 hover:scale-110 hover:bg-rose-100 dark:hover:bg-rose-900/40']) }}>
